...
module Hyrax
  module Workflow
    class TombstoneInitiateNotification < AbstractNotification
      private

      def subject
        I18n.t('hyrax.notifications.workflow.tombstone_initiate.subject', user: user.user_key)
      end

      def message
        I18n.t('hyrax.notifications.workflow.tombstone_initiate.message',
                title: title,
